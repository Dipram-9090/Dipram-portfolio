...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={socialsRef}
        className="lg:flex md:hidden hidden absolute z-20 bottom-8 left-0 w-full justify-center lg:justify-start lg:bottom-70 lg:left-0 lg:w-auto lg:px-8 text-white will-change-transform"
      >
        <Socials />
      </div>
    </div>
