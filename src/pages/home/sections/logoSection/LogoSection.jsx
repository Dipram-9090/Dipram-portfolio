...
const LogoSection = () => {
  ...
  useGSAP(
    ...
    { scope: containerRef, dependencies: [viewport] } // Re-run GSAP if viewport changes (optional but safer)
  );
    ...
    >
      ...
      <div className="w-full h-[35%] lg:w-1/2 lg:h-full flex flex-col justify-end lg:justify-center items-center lg:items-start px-6 pb-4 lg:p-20 z-10 text-center lg:text-left">
        <div className="flex flex-col gap-4 lg:gap-6 items-center lg:items-start">
          ...
          <div className="w-1/2 lg:w-full h-px bg-white/20 origin-center lg:origin-left" />
          <p className="font-euclid text-sm md:text-lg lg:text-2xl text-white/70 max-w-xs md:max-w-md leading-relaxed">
            A curated collection of logos crafted with strong concepts. <br />
