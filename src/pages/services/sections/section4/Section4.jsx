...
const Section4 = () => {
  ...
  return (
    ...
    >
      <h1 className="section4Class">
        Let's <span>Build</span> Something <span>Great</span>
      </h1>

      <div ref={buttonRef} className="flex flex-col lg:flex-row gap-4 md:gap-6 items-center justify-center w-full">
        <ContactButton className="w-full lg:w-auto md:w-[60%] cursor-pointer duration-200 hover:bg-[#19E6B6] font-euclid font-medium text-black bg-white rounded-full 
            text-lg px-8 py-3 
            md:text-2xl md:px-10 
            lg:text-4xl lg:px-12 lg:py-2 whitespace-nowrap">
          GET IN TOUCH
        </ContactButton>
        <ProjectsButton className="w-full lg:w-auto md:w-[60%] cursor-pointer duration-200 hover:bg-[#19E6B6] hover:border-[#19E6B6] hover:text-black font-euclid font-medium text-white uppercase border-4 rounded-full 
            text-lg px-8 py-2.5 
            md:text-2xl md:px-10 
